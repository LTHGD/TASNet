...
def main():
    net = TASNet(backbone_path).cuda(device_ids[0])

    #net.load_state_dict(torch.load('TASNet.pth'))
    net.load_state_dict(torch.load('ckpt/TASNet/45.pth'))
    #print('Load {} succeed!'.format('TASNet.pth'))
    print('Load {} succeed!'.format('ckpt/TASNet/45.pth'))
